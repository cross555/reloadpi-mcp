...
//
// Transport: SSE (HTTP) — suitable for remote hosting on mcp.reloadpi.com
...
server.tool(
  ...
  async ({ orderId }) => {
    // Free endpoint — plain axios, no x402 wrapper needed
...
app.listen(PORT, () => {
  ...
  console.log(`   Production:   https://mcp.reloadpi.com/sse`);
});